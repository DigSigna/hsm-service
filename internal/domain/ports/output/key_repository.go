...
// KeyRepository - Puerto de salida para persistencia de claves
type KeyRepository interface {
	...
	FindByOwner(ctx context.Context, ownerID string) (*entities.CryptographicKey, error)
	FindByOwnerType(ctx context.Context, ownerType string) ([]*entities.CryptographicKey, error)
